        ...
        while ($row = $result->fetchRow()) {
            ...
            <tr>
                <td class="trash">
                    ...
                    <img style="border:0;width:10px;height:16px" title="<?php printf (_("Delete group %s"), $row['name']); ?>" 
                        src="images/trashcan.gif" alt="trashcan"></a>
                </td>
                <td><a href="admingroupchange.php?group_id=<?php echo $row['id']; ?>" 
                    title="<?php printf (_("Click to modify %s"), $row['name']); ?>">
