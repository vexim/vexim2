...
<html>
  ...
  <body>
    ...
    <div id="Content">
    <table align="center">
      <tr><th>&nbsp;</th><th><?php echo _("Failed Address"); ?>..</td></tr>
      <?php
	...
	if ($result->numRows()) {
	  while ($row = $result->fetchRow()) {
	    ...
	    print "<img style='border:0;width:10px;height:16px' src=\"images/trashcan.gif\" title=\"";
        printf (_("Delete fail %s"), $row['localpart']);
        print "\"></a></td>\n";
