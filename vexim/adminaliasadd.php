...
<html>
  ...
  <body onLoad="document.adminadd.realname.focus()">
	...
	<tr><td><?php echo _("Verify Password"); ?>:</td><td><input name="vclear" type="password" size="30" class="textfield"></td></tr>
	<tr><td><?php echo _("Admin"); ?>:</td><td><input name="admin" type="checkbox" class="textfield"></td></tr>
	...
	?>
	<tr><td><?php echo _("Enabled"); ?>:</td><td><input name="enabled" type="checkbox" class="textfield" checked></td></tr>
