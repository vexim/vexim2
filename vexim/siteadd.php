...
<html>
  ...
  <div id='forms'>
	...
	<tr><td><?php echo _("New Domain"); ?>:</td><td><input name="domain" type="text" class="textfield"></td>
	    <td><?php echo _("The name of the new domain you are adding"); ?></td></tr>
	<?php if ($_GET['type'] == "local") {
	   print "
	     ...
	     <tr><td>" . _("Maximum accounts") . "<br/>(" . _("0 for unlimited") . "):</td><td><input type=\"text\" size=\"5\" name=\"max_accounts\" value=\"0\" class=\"textfield\"></td></tr>
	     <tr><td>" . _("Max mailbox quota") . "(" . _("0 for disabled") . "):</td>
		 <td><input name=\"quotas\" size=\"5\" type=\"text\" class=\"textfield\" value=\"0\"> " . _("Mb") . "</td></tr>
	     <tr><td>" . _("Maximum message size") . ":</td>
		 <td><input name=\"maxmsgsize\" size=\"5\" type=\"text\" class=\"textfield\" value=\"0\"> " . _("Kb") . "</td>
