<?
  ...
  if (($domheaderrow['enabled'] == "0") || ($domheaderrow['enabled'] == "f")) {
	...
	if (isset($_GET['deleted'])) {
	  ...
	  print "User '{$_GET['nodel']}' cannot be deleted or have admin rights removed.<br>\n";
	  print "It is the last admin account. Create another admin account first.\n";
	  ...
	  print "Account {$_GET['badaliaspass']} could not be added.<br>\n";
	  print "Your passwords do not match, or contain illegal characters: ' \" ` or ;\n";
	} else if (isset($_GET['maxaccounts'])) {
	  print "Account Limit Reached.<br>\n";
	  ...
	  print "This domain is currently disabled.<br>\n";
