...
<html>
  ...
  <body>
    ...
    <div id="Centered">
      <table align="center">
	<tr><td><a href="adminuser.php"><?php echo _("Add, delete and manage POP/IMAP accounts"); ?></a></td></tr>
	<tr><td><a href="adminalias.php"><?php echo _("Add, delete and manage aliases, forwards and a Catchall"); ?></a></td></tr>
	<tr><td><a href="admingroup.php"><?php echo _("Add, delete and manage groups"); ?></a></td></tr>
	<tr><td><a href="adminfail.php"><?php echo _("Add, delete and manage :fail:'s"); ?></a></td></tr>
	  <?php
	    if ($mailmanroot != "") {
