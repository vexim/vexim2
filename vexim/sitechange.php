    ...
    <table align="center">
        ...
        <form name="domainchange" method="post" action="sitechangesubmit.php">
            ...
            <tr>
                ...
                <td><input type="text" size="5" name="max_accounts" value="<?php print $row['max_accounts']; ?>"
                           class="textfield"></td>
            </tr>
            <tr>
                <td><?php echo _("Max mailbox quota in Mb") . "<br />(" . _("0 for disabled") . ")"; ?>:</td>
                <td><input type="text" size="5" name="quotas" value="<?php print $row['quotas']; ?>" class="textfield">
                </td>
            </tr>
            <tr>
                <td><?php echo _("Maximum message size"); ?>:</td>
                <td><input name="maxmsgsize" size="5" type="text" class="textfield"
                           value="<?php print $row['maxmsgsize']; ?>"> Kb
                </td>
            </tr>
            <tr>
                <td><?php echo _("Spamassassin tag score"); ?>:</td>
                <td><input type="text" size="5" name="sa_tag" value="<?php print $row['sa_tag']; ?>" class="textfield">
                </td>
            </tr>
            <tr>
                <td><?php echo _("Spamassassin refuse score"); ?>:</td>
                <td><input type="text" size="5" name="sa_refuse" value="<?php print $row['sa_refuse']; ?>"
                           class="textfield"></td>
            </tr>
            <tr>
                <td><?php echo _("Spamassassin"); ?>:</td>
                <td><input type="checkbox" name="spamassassin" <?php if ($row['spamassassin'] == 1) {
                        print "checked";
                    } ?>></td>
            </tr>
            <tr>
                <td><?php echo _("Anti-virus"); ?>:</td>
                <td><input type="checkbox" name="avscan" <?php if ($row['avscan'] == 1) {
                        print "checked";
                    } ?>></td>
            </tr>
            <tr>
                <td><?php echo _("Piping to command"); ?>:</td>
                <td><input type="checkbox" name="pipe" <?php if ($row['pipe'] == 1) {
                        print "checked";
                    } ?>></td>
            </tr>
            <tr>
                <td><?php echo _("Enabled"); ?>:</td>
                <td><input type="checkbox" name="enabled" <?php if ($row['enabled'] == 1) {
                        print "checked";
                    } ?>></td>
                <td><input name="domain_id" type="hidden" value="<?php print $_GET['domain_id']; ?>">
                    <input name="domain" type="hidden" value="<?php print $_GET['domain']; ?>"></td>
        ...
        <form name="sadisable" method="post" action="sitechangesubmit.php">
            <tr>
                <td><?php echo _("Disable SpamAssassin for all domain users") . "<br><b>(" . _("Warning: cannot be reversed!") . ")</b>:</td>\n"; ?>
                <td><input name="sadisable" type="hidden" value="sadisable">
                    <input name="domain_id" type="hidden" value="<?php print $_GET['domain_id']; ?>">
                    <input name="submit" type="submit" value="<?php echo _("Disable"); ?>"></td>
            </tr>
        </form>
        <form name="avdisable" method="post" action="sitechangesubmit.php">
            <tr>
                <td><?php echo _("Disable Anti-Virus for all domain users") . "<br><b>(" . _("Warning: cannot be reversed!") . ")</b>:</td>\n"; ?>
