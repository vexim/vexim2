...
<html>
  <head>
	...
	<table align="center">
	  <tr><td colspan='2'><?php printf (_("Please confirm deleting user %s@%s"), $row['localpart'], $_SESSION['domain']); ?>:</td></tr>
	  <tr><td><input name='confirm' type='radio' value='cancel' checked><b> <?php printf (_("Do Not Delete %s@%s"), $row['localpart'], $_SESSION['domain']); ?></b></td></tr>
	  <tr><td><input name='confirm' type='radio' value='1'><b> <?php printf (_("Delete %s@%s"), $row['localpart'], $_SESSION['domain']); ?></b></td></tr>
