  ...
  <div id='Content'>
	...
	if ($result->numRows()) {
	  while ($row = $result->fetchRow()) {
	    ...
	    print "<img style=\"border:0;width:10px;height:16px\" title=\"" . _("Delete") . $row['domain'] . "\" src=\"images/trashcan.gif\" alt=\"trashcan\"></a></td>\n";
	...
	if ($result->numRows()) {
	  while ($row = $result->fetchRow()) {
	    ...
	    print "<img style=\"border:0;width:10px;height:16px\" title=\"" . _("Delete") . $row['alias'] . "\" src=\"images/trashcan.gif\" alt=\"trashcan\"></a></td>\n";
