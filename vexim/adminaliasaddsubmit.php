<?php
  ...
  if (alias_validate_password($_POST['clear'], $_POST['vclear'])) {
    $query = "INSERT INTO users
      (localpart, username, domain_id, crypt,";
       if($saveclearpw==1) $query .= " clear,";
    $query .= "smtp, pop, uid, gid, realname, type, admin, on_avscan, on_spamassassin, enabled)
      SELECT :localpart, :username, :domain_id, :crypt,";
      if($saveclearpw==1) $query .=" :clear,";
      $query .= ":smtp, :pop, uid, gid, :realname, 'alias', :admin,
